...
const Messanger = (props) => {
  return (
    <div className={classes.messanger}>
      ...
      <Messanger__messages messages={props.state.messages} inputState={props.state.inputMessage} writeMessage={props.writeMessage} changeInputMessage={props.changeInputMessage}/>
    </div>
  )
}
